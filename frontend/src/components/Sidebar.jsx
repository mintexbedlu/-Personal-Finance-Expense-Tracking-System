...
// click outside to close mobile sidebar collapsed
...
// a small component for menu item
...
<Link className={cn(sidebarStyles.footerLink.base,
isCollapsed && sidebarStyles.footerLink.collapsed )} 
to="https://skillbridge.tech/contact-us/" >
...
"mt-2")}>
  ...
  {!isCollapsed && <span>Logout</span>}
   ...
   <motion.button onClick={()=>setMobileOpen((prev)=>!prev)} 
    ...
    whileHover={{scale:105}} whileTap={{scale:0.95}}>
