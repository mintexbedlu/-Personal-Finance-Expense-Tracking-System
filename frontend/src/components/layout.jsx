...
const Layout = ({ onLogout, user }) => {
  ...
  //to add tarnsaction either income or expense
        ...
        <div className={styles.statCards.grid}>
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              ...
              <div className={styles.statCards.iconContainer("indigo")}>
                <DollarSign className={styles.statCards.icon("indigo")} />
              </div>
            </div>

            <p className={styles.statCards.cardFooter}>
              <span className="text-indigo-600 font-medium font-bold">
                +ETB {stats.last30DaysSavings.toLocaleString()}
              </span>
              {""}
              this month
            </p>
          ...
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              ...
              <div className={styles.statCards.iconContainer("emerald")}>
                <ArrowUp className={styles.statCards.icon("emerald")} />
              </div>
            </div>

            <p className={styles.statCards.cardFooter}>
              <span className="text-emerald-600 font-medium font-bold">+12.5%</span>
              {""}
              last month
            </p>
          </div>
          ...
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              ...
              <div className={styles.statCards.iconContainer("rose")}>
                <ArrowDown className={styles.statCards.icon("rose")} />
              </div>
            </div>
            ...
            <p className={styles.statCards.cardFooter}>
              ...
              >
                ...
                {stats.expenseChange.toLocaleString()}%
              </span>
              {""}
              from last month
            </p>
          ...
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              ...
              <div className={styles.statCards.iconContainer("violet")}>
                <PiggyBank className={styles.statCards.icon("violet")} />
              </div>
            </div>

            <p className={`${styles.statCards.cardFooter} font-semibold text-violet-600`}>
                ...
                <div className={styles.categories.summaryGrid}>
                  ...
                  <div className={styles.categories.summaryIncomeCard}>
                    ...
                    <p className={styles.categories.summaryValue}>
                      ETB {stats.allTimeIncome.toLocaleString()}
                    </p>
                  </div>
                  ...
                  <div className={styles.categories.summaryExpenseCard}>
                    ...
                    <p className={styles.categories.summaryValue}>
                      ETB {stats.allTimeExpenses.toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
